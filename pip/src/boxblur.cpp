...
//         _mm_prefetch((const char *)&a(xBase + 16, y, comp), _MM_HINT_T0);
...
//       for (int y = 0; y < ny; y++) {
//         _mm_prefetch((const char *)&a(x, y + nblur + 40, comp), _MM_HINT_T0);
//         _mm_prefetch((const char *)&a(x + 16, y + nblur + 40, comp), _MM_HINT_T0);
//         __m256 res[4];
// #ifdef _MSC_VER
// #pragma unroll 4
// #else
...
//           for (int offset = 0; offset < 4; offset++) {
//             res[offset] =
//                 _mm256_add_ps(res[offset], _mm256_load_ps(&a(x + offset * 8, y + t, comp)));
//           }
//         }
// #ifdef _MSC_VER
// #pragma unroll 4
